=head1 ActivePerl 1402 -- Release Notes

Welcome, and thank you for downloading ActivePerl.  This release
corresponds to Perl version 5.14.2.
...
Mac OS X 10.5 or later (x86, 32 and 64 bit)
...
see the ActivePerl 5.14 Change Log.

=for html
<p>For a chronological list of changes included in this and past releases,
see the <a href="changes.html">ActivePerl 5.14 Change Log</a>.</p>

=head1 Incompatibilities

Perl 5.14 is not binary compatible with Perl 5.12, 5.10 or 5.8.  In particular, do not
attempt to use extensions or PPM packages built for ActivePerl 800, 1000 and 1200
series builds with ActivePerl 1400 series builds and vice versa.  Please
check L<perl5140delta/Incompatible Changes> for known source level
incompatibilities between the Perl 5.14 releases and the earlier release
series.
...
ActivePerl 5.14 over an older version of ActivePerl based on 5.12, 5.10, 5.8, 5.6 or
...
was installed in F</opt/ActivePerl-5.14> then the HTML documentation
would be located in F</opt/ActivePerl-5.14/html>.
