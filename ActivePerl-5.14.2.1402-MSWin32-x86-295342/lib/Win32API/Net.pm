...
name, fullName, password (array), passwordAge, priv, homeDir, comment, flags,
scriptPath, usrComment, workstations, lastLogon, lastLogoff, maxStorage,
unitsPerWeek, logonHours, numLogons, logonServer, countryCode, codePage,
parms
...
=item C<password (array)> - 16 bytes array

The password to be set. Specifies a one-way encrypted LAN Manager
2.x-compatible password.
...
=item C<userSid> - Scalar String

Secure Identifier that uniquely identifies the user. A SID has the format
I<S-R-I-S...>. In this notation, the literal character "S" identifies the
series of digits as a SID, I<R> is the revision level, I<I> is the
identifier-authority value, and I<S...> is one or more subauthority values.
...
name, comment, groupSid, attributes.
...
Secure Identifier that uniquely identifies the group. A SID has the format
I<S-R-I-S...>. In this notation, the literal character "S" identifies the
series of digits as a SID, I<R> is the revision level, I<I> is the
identifier-authority value, and I<S...> is one or more subauthority values.
