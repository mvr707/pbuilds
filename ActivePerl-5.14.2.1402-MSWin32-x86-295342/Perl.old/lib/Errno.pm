...
"MSWin32-x86-multi-thread-5.2" or
	die "Errno architecture (MSWin32-x86-multi-thread-5.2) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
