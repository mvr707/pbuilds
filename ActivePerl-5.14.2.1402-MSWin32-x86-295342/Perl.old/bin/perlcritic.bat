...
##############################################################################
#      $URL: http://perlcritic.tigris.org/svn/perlcritic/trunk/distributions/Perl-Critic/bin/perlcritic $
...
ActiveState also makes a Perl Development Kit (PDK).  Starting with version 8,
the PDK includes a very slick graphical interface for configuring and running
Perl-Critic.   Free trial copies of the PDK can be obtained from the ActiveState
website at L<http://www.activestate.com>.
...
Also, the Perl Development Kit (PDK 8.0) from ActiveState includes
a very slick graphical interface to Perl-Critic.  For details,
go to L<http://www.activestate.com/perl_dev_kit>
