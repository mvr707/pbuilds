...
#!perl
#line 15
    eval 'exec C:\pbuilds\ActivePerl-5.14.2.1402-MSWin32-x86-295342\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\pbuilds\ActivePerl-5.14.2.1402-MSWin32-x86-295342\bin\perl.exe';
