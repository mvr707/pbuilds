 ...
 * contents of TryCatch.xs. Do not edit this file, edit TryCatch.xs instead.
 *
...
XS(XS_TryCatch__XS_install_op_checks); /* prototype to pass -Wmissing-prototypes */
XS(XS_TryCatch__XS_install_op_checks)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_TryCatch__XS_uninstall_op_checks); /* prototype to pass -Wmissing-prototypes */
XS(XS_TryCatch__XS_uninstall_op_checks)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items != 1)
       croak_xs_usage(cv,  "aref");
    {
	SV*	aref = ST(0)
;
#line 255 "TryCatch.xs"
    AV* av;
    SV *op, *id;
#line 349 "TryCatch.c"
#line 258 "TryCatch.xs"
...
XS(XS_TryCatch__XS_dump_stack); /* prototype to pass -Wmissing-prototypes */
XS(XS_TryCatch__XS_dump_stack)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
XS(XS_TryCatch__XS_set_linestr_offset); /* prototype to pass -Wmissing-prototypes */
XS(XS_TryCatch__XS_set_linestr_offset)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
extern "C"
#endif
XS_EXTERNAL(boot_TryCatch); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_TryCatch)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK;
        ...
        newXS("TryCatch::XS::install_op_checks", XS_TryCatch__XS_install_op_checks, file);
        newXS("TryCatch::XS::uninstall_op_checks", XS_TryCatch__XS_uninstall_op_checks, file);
        newXS("TryCatch::XS::dump_stack", XS_TryCatch__XS_dump_stack, file);
        newXS("TryCatch::XS::set_linestr_offset", XS_TryCatch__XS_set_linestr_offset, file);

    /* Initialisation Section */

#line 282 "TryCatch.xs"
{
